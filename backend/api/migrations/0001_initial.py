# Generated by Django 4.2.7 on 2025-12-29 03:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "post_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="发布信息ID"
                    ),
                ),
                (
                    "post_type",
                    models.SmallIntegerField(
                        choices=[(1, "科研项目"), (2, "竞赛项目"), (3, "学生技能")],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "student_name",
                    models.CharField(max_length=255, verbose_name="学生姓名"),
                ),
                (
                    "grade",
                    models.SmallIntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "tag_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="标签号"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "teacher_id",
                    models.IntegerField(
                        primary_key=True, serialize=False, verbose_name="教工号"
                    ),
                ),
                (
                    "teacher_name",
                    models.CharField(max_length=255, verbose_name="教师姓名"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "token",
                    models.CharField(
                        blank=True, max_length=64, null=True, verbose_name="认证令牌"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "cooperation_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="合作关系ID"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "skill_degree",
                    models.CharField(max_length=255, verbose_name="技能程度"),
                ),
                (
                    "project_experience",
                    models.CharField(max_length=255, verbose_name="项目经验"),
                ),
                (
                    "experience_file",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="经验文件"
                    ),
                ),
                (
                    "habit_tag",
                    models.CharField(max_length=255, verbose_name="习惯标签"),
                ),
                (
                    "spend_time",
                    models.CharField(max_length=255, verbose_name="可投入时间"),
                ),
                (
                    "expect_worktype",
                    models.CharField(max_length=255, verbose_name="期望工作类型"),
                ),
                ("filter", models.CharField(max_length=255, verbose_name="筛选条件")),
                (
                    "certification",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="证书"
                    ),
                ),
                (
                    "student",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "research_name",
                    models.CharField(max_length=255, verbose_name="科研项目名称"),
                ),
                (
                    "research_direction",
                    models.CharField(max_length=255, verbose_name="研究方向"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "competition_type",
                    models.CharField(max_length=255, verbose_name="竞赛类型"),
                ),
                (
                    "competition_name",
                    models.CharField(max_length=255, verbose_name="竞赛名称"),
                ),
                ("deadline", models.DateTimeField(verbose_name="截止时间")),
                (
                    "team_require",
                    models.CharField(max_length=255, verbose_name="团队要求"),
                ),
                (
                    "guide_way",
                    models.CharField(max_length=255, verbose_name="指导方式"),
                ),
                (
                    "reward",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="奖励"
                    ),
                ),
                (
                    "appendix",
