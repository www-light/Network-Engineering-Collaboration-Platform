...
import { Link, Message, Download, Star, StarFilled, Collection, CollectionTag, Edit } from '@element-plus/icons-vue'
import { downloadFile, getProjectDetail, updateRecruitStatus } from '@/api/project'
